...
def main():
  ...
  parser.add_argument(
      '-i', '--imageDir',
      help="Path to the folder where the images dataset is stored. If not specified, the CWD will be used.",
      type=str,
      default=os.getcwd()  
  )
  parser.add_argument(
  ...
  parser.add_argument(
      '-x', '--xml',
      help="Set this flag if yo want the xml annotation files to be processed and copied over.",
      action='store_true'
  )
